...
// The threads try to lock the mutexes in a different order
// This results in deadlock when each thread has to wait
// for the other thread to unlock before it can proceed.
...
// Lock mutex 2, then try to lock mutex 1
void func2() {
